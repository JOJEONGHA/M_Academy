webpackJsonp([ 0 ], [ function(e, t, i) {
 ...
 var a = i(1), r = n(a), o = i(5), l = n(o), h = i(12), u = i(24), c = i(121), _ = n(c), d = i(14);
 i(127);
 var f = new r["default"](l["default"](h.ROOT_VIEW_SELECTOR)[0]), v = window.location.href.replace(s(), "").split("#")[0], p = "home" === u.slugFromPath(v);
 p ? !function() {
  window.scrollTo(0, 0);
  var e = window.innerWidth <= 792, t = window.innerHeight / 2, i = e ? 100 :256, n = window.innerHeight - i, s = Math.floor(e ? t - i + 27 :t - i + 158), a = l["default"](".site-header")[0], r = l["default"]("._page-title", a)[0], o = new _["default"](f, r, 40), h = l["default"](".js-header-background")[0], u = l["default"]("._nav-text")[0], c = l["default"](".js-fake-shadow", h)[0];
  e ? d.set(u, {
   opacity:0,
   y:50
  }) :d.set(u, {
  ...
  var v = l["default"](".grid-block").filter(function(e) {
   return e.getBoundingClientRect().top <= window.innerHeight;
  });
  d.set(v, {
   y:window.innerHeight - (e ? 100 :256)
  }), setTimeout(function() {
   o.runSequence().then(function() {
    var t = void 0;
    return t = e ? d.to(u, .3, {
     opacity:1,
     y:0,
     ...
     opacity:1,
     delay:.85
    }), TweenMax.staggerTo(v, .6, {
     y:0,
     delay:.25,
     ease:Cubic.easeInOut
    }, .05), Promise.all([ d.to(h, .6, {
     y:-n,
     delay:.2,
     ease:Cubic.easeInOut
    }), d.to(r, .6, {
    ...
    a.classList.remove("-homepage"), f.start(), d.set(h, {
     y:0
    }), d.set(r, {
     y:0
    }), d.set(c, {
 ...
 var r = function() {
 ...
 }(), o = i(2), l = i(3), h = s(l), u = i(4), c = s(u), _ = i(5), d = s(_), f = i(6), v = s(f), p = i(8), m = s(p), g = i(9), y = s(g), E = i(10), w = s(E), k = i(13), b = n(k), A = i(25), T = i(31), S = s(T), C = i(101), L = s(C), R = i(102), P = s(R), O = i(103), x = s(O), I = i(24), M = i(109), D = s(M), N = i(12), H = function() {
  function e(t) {
   a(this, e), this._elem = t, this._pageContainerElem = d["default"](N.PAGE_WRAPPER_SELECTOR, this._elem)[0], 
   this._scrollWatcher = new w["default"](this), this._resizeWatcher = new v["default"](D["default"]), 
   this._animationFrameWatcher = new m["default"](), this._urlWatcher = new y["default"](this), 
  ...
  return r(e, [ {
   ...
   value:function() {
    var e = this;
    h["default"].attach(document.body), this._testForTouch(), this._currentPageController = this._setupPage(d["default"](N.PAGE_CONTAINER_SELECTOR, this._pageContainerElem)[0]);
    var t = d["default"](N.STICKY_HEADER_SELECTOR, this._elem)[0];
    if (t) {
     this._stickyHeader = new S["default"](this, t), d["default"](N.HIDDEN_CHARACTER_CONTAINER_SELECTOR, t).map(function(t) {
      return new P["default"](e, t);
     });
     var i = I.pathFromSlug("home") === window.location.pathname;
     this._stickyHeader.transitionHiddenOnHomepage(0, i);
    }
    var n = d["default"](N.NAV_STATE_SELECTOR, this._elem)[0];
    n && setTimeout(function() {
     e._navState = new L["default"](e, n);
    }, 400), o.bindAll(this, "_urlChange"), this._urlWatcher.on(g.URL_CHANGE_EVENT, this._urlChange), 
    this._currentPageController.trigger(O.READY_EVENT);
   }
  }, {
   key:"_urlChange",
   value:function(e, t) {
   ...
   value:function(e, t) {
    ...
    return regeneratorRuntime.async(function(d) {
     ...
     case 0:
      ...
      l = o ? Promise.resolve(o) :A.getHTML(r), d.next = 10, b.animateOut({
       url:t,
       controller:n
      }, {
       url:e
     ...
     case 29:
      return this._currentPageController = _, _.trigger(O.READY_EVENT), d.abrupt("return", Promise.resolve());
   ...
   key:"_setupPage",
   value:function(e) {
    var t = d["default"](N.SCROLL_ELEMENT_SELECTOR, e)[0];
    return this._scrollWatcher.changeTargetElement(window), new x["default"](this, e, t);
   }
  }, {
   key:"_testForTouch",
   value:function() {
    var e = "ontouchstart" in window || window.navigator.MaxTouchPoints > 0 || window.navigator.msMaxTouchPoints > 0;
    e && document.body.classList.add(N.TOUCH_TEST_CLASSNAME);
   }
  }, {
   key:"tearDown",
   value:function() {
   ...
   value:function(e) {
    var t = void 0 === arguments[1] ? !1 :arguments[1];
    this._scrollWatcher.on(E.SCROLL_START_EVENT, e, t);
   }
  }, {
   key:"offScrollStart",
   value:function(e) {
    this._scrollWatcher.off(E.SCROLL_START_EVENT, e);
   }
  }, {
   key:"onScroll",
   value:function(e) {
    var t = void 0 === arguments[1] ? !1 :arguments[1], i = void 0 === arguments[2] ? !1 :arguments[2];
    t ? this._scrollWatcher.on(E.SCROLL_REALTIME_EVENT, e, i) :this._scrollWatcher.on(E.SCROLL_EVENT, e, i);
   }
  }, {
   key:"offScroll",
   value:function(e) {
    var t = void 0 === arguments[1] ? !1 :arguments[1];
    t ? this._scrollWatcher.off(E.SCROLL_REALTIME_EVENT, e) :this._scrollWatcher.off(E.SCROLL_EVENT, e);
   }
  }, {
   key:"onScrollEnd",
   value:function(e) {
    var t = void 0 === arguments[1] ? !1 :arguments[1];
    this._scrollWatcher.on(E.SCROLL_END_EVENT, e, t);
   }
  }, {
   key:"offScrollEnd",
   value:function(e) {
    this._scrollWatcher.off(E.SCROLL_END_EVENT, e);
   }
  }, {
   ...
   key:"trackElement",
   value:function(e, t) {
    this._scrollWatcher.trackElement(e, t);
   }
  }, {
   key:"untrackElement",
   value:function(e) {
 ...
 var c = "click", _ = "js-disable-ajax-link", d = function() {
  ...
  return r(e, [ {
   ...
   value:function(e) {
    ...
    return t === e ? !1 :(this.trigger(u, e, this._currentURL), window.ga("send", "pageview", e), 
 ...
 var m = "keyup";
 t.KEYUP_EVENT = m;
 var g = 200, y = 100, E = -1 !== navigator.userAgent.indexOf("MSIE 10"), w = 8, k = function() {
  function e(t, i, n) {
   s(this, e), this._app = t, i = "number" == typeof i ? i :g, n = "number" == typeof n ? n :y, 
   ...
   r.bindAll(this, "_didScroll", "_onFrame", "_checkKeyboardScroll");
  }
  return a(e, [ {
   ...
   value:function() {
    return this._scrollParent !== window ? this._scrollParent.scrollTop :E && window.pageYOffset !== document.documentElement.scrollTop ? document.documentElement.scrollTop :window.pageYOffset || document.documentElement.scrollTop;
   }
  }, {
   key:"_didScroll",
   value:function() {
   ...
   key:"trackElement",
   value:function(e, t) {
    this._isVisible(e) && !this._isPaused ? t(e) :this._trackedElements.set(e, t);
   }
  }, {
   key:"_attachEvents",
   value:function() {
 ...
 var v = ".js-scroll-to-target";
 t.ANIMATE_SCROLL_SELECTOR = v;
 var p = ".js-search-component";
 t.SEARCH_COMPONENT_SELECTOR = p;
 var m = ".js-share-fab";
 t.SHARE_FAB_SELECTOR = m;
 var g = ".js-hover-animation";
 t.HOVER_ANIMATION_SELECTOR = g;
 var y = ".js-nav-state";
 t.NAV_STATE_SELECTOR = y;
 var E = "touch";
 t.TOUCH_TEST_CLASSNAME = E;
 var w = ".js-quote-tile";
 t.QUOTE_SELECTOR = w;
 var k = "-active";
 t.STATE_ACTIVE = k;
 ...
 t.STATE_INACTIVE = A;
 var T = 64;
 t.MINIMUM_HEADER_HEIGHT = T;
 var S = 100;
 t.MINIMUM_HEADER_HEIGHT_MOBILE = S;
 var C = 256;
 t.MAXIMUM_HEADER_HEIGHT = C;
}, function(e, t, i) {
 "use strict";
 function n(e, t, i) {
  r.set(e.rootNode, {
 ...
 function s(e, t, i, n, s) {
  var a = o.isDetail(t.url), l = o.isDetail(e.url), h = "home" === o.slugFromPath(t.url);
  e.controller.hideFakeShadow();
  var u = .8, c = "light" === o.getContrast(t.url) ? "#ffffff" :"rgba(0, 0, 0, 0.7)", _ = null;
  return e.controller.hideFakeHeader(), a && (_ = o.getContrastHeaderColor(t.url), 
  _ || (_ = "light" === o.getContrast(t.url) ? "rgba(0, 0, 0, 0.5)" :"rgba(255, 255, 255, 0.5)")), 
  s ? r.set(e.controller.rootElem, {
   autoAlpha:0
  }) :r.to(e.controller.rootElem, u / 4, {
   autoAlpha:0
  }), Promise.all([ i.expandHeader(u, o.getColor(t.url), _, o.getTitle(t.url).split(" - ")[0], o.getContrast(t.url), l, a).then(function() {
   return a || e.controller.hideFakeHeader(), Promise.resolve();
  }), i.setContrast(u / 2, c), n.moveTracker(o.slugFromPath(t.url), o.shouldHideNavigation(t.url), c), i.transitionHiddenOnHomepage(u / 2, h) ]);
 }
 function a(e, t, i) {
  document.title = o.getTitle(t.url);
  var n = o.isDetail(t.url);
  t.controller.hideFakeShadow(), t.controller.hideFakeHeader();
  var s = .8;
  return Promise.all([ i.animateNewTitle(s), r.to(t.controller.rootElem, s, {
   y:0,
   ease:Expo.easeOut
  }), r.set(t.controller.rootElem, {
   autoAlpha:1
  }) ]).then(function() {
   return t.controller.showFakeShadow(), t.controller.showFakeHeader(), i.restoreHiddenHeader(n, o.getContrast(t.url));
  });
 }
 Object.defineProperty(t, "__esModule", {
  value:!0
 }), t.prepare = n, t.animateOut = s, t.run = a;
 var r = i(14), o = i(24);
}, function(e, t, i) {
 "use strict";
 ...
 function s(e) {
  if (e === window.HTTP_PREFIX) return {
   type:"page",
   id:e
  };
 ...
 function l(e) {
  var t = s(e);
  return "page" === t.type && window.META_JSON[t.type][t.id] && "search" === window.META_JSON[t.type][t.id].slug ? !0 :t.type && "page" !== t.type && null !== t.id;
 }
 function h(e) {
  var t = s(e), i = t.type, n = t.id;
  if (i && n) {
 ...
 function c(e) {
  ...
  if ("page" === i && a && "home" !== a) {
   ...
   if (r && r.title) return "" + r.title + " - " + window.DEFAULT_TITLE;
  }
  if (i && a) {
   var o = n(i), r = window.META_JSON[i][a];
 ...
 var o = function() {
 ...
 }(), l = i(14), h = i(2), u = i(5), c = n(u), _ = i(99), d = n(_), f = i(32), v = n(f), p = i(24), m = i(12), g = i(100), y = n(g), E = Math.abs, w = Math.max, k = Math.floor, b = ".js-wave-layer", A = ".js-sticky-header-fade", T = ".js-hidden-on-homepage", S = ".js-animate-contrast-color", C = ".js-animate-contrast-fill", L = ".js-search-is-active", R = ".js-wave-trigger", P = ".js-header-background", O = ".js-fake-shadow", x = ".js-hide-page-title", I = ".js-change-page-title-contrast", M = ".js-nav-row", D = "color", N = "contrast", H = "overlay", B = function() {
  function e(t, i) {
   var n = this;
   s(this, e), this._app = t, this._elem = i, this._navScroller = c["default"](m.NAV_STATE_SELECTOR)[0], 
   this._headerChild = c["default"](P)[0], this._headerChildTitleContainer = c["default"](I, this._elem)[0], 
   this._headerChildTitle = c["default"](x, this._elem)[0], this._navRow = c["default"](M, this._elem)[0], 
   this._fakeShadow = c["default"](O, this._navRow)[0], this._headerColor = v["default"](this._elem)[D], 
   ...
   this._headerContrast = v["default"](this._elem)[N], this._fadeItems = null, this._shouldRevealLogoOnScroll = !1, 
   this._hiddenOnHomepage = c["default"](T, this._elem)[0], this._searchIsActiveElem = c["default"](L, this._elem)[0], 
   ...
   this._wave = new y["default"](this._app, this._waveLayer), this._wave.append(), 
  ...
  return o(e, [ {
   ...
   value:function(e) {
    this._fadeItems = c["default"](A, e), this._checkPosition();
   }
  }, {
   key:"_attachEvents",
   value:function() {
   ...
   value:function() {
    if (this._isDepressed) {
     var e = E(this._navScroller.scrollLeft - this._startingScrollX);
   ...
   value:function(e) {
    ...
    if ("mobile" !== this._app.currentBreakpoint() && !this._isTransitioning) {
     ...
     for (var i = [], n = 0; n < k(E(t) / 6); n++) i[n] = e + t * (n + 1);
 ...
 function a(e, t) {
  return y(E(e.x - t.x, 2) + E(e.y - t.y, 2));
 }
 function r(e, t, i, n, s) {
  var a = 0 >= t ? k :s, r = e / 1e3, o = t / 1e3, l = r + o, h = 1.2 * m(y(i * i + n * n), a) + 5, u = 1 * (h / a), c = l / u, _ = h * (1 - E(40, -c));
  return w(_);
 }
 function o(e, t, i) {
  var n = t / 1e3;
 ...
 var _ = function() {
 ...
 }(), d = i(2), f = i(14), v = i(11), p = n(v), m = Math.min, g = Math.max, y = Math.sqrt, E = Math.pow, y = Math.sqrt, w = Math.abs, k = 75, b = .3, A = {
  x:0,
  y:0
 }, T = {
  x:1,
  ...
  return _(e, [ {
   ...
   value:function() {
    ...
    this._containerRect.w = e.width, this._containerRect.h = e.height, this._maxRadius = 1.6 * c(A, this._containerRect), 
 ...
 var a = function() {
 ...
 }(), r = i(2), o = i(5), l = n(o), h = i(32), u = n(h), c = i(14), _ = i(24), d = ".js-nav-state-item", f = ".js-nav-state-hide", v = "navStateSlug", p = "2px", m = .6, g = .0021, y = .45, E = .9, w = {
  startX:0,
  targetX:0,
  distance:0,
  rotation:0,
  ...
  return a(e, [ {
   ...
   value:function(e, t, i) {
    ...
    y > h ? h = y :h > E && (h = E), c.to(this._tracker, h, {
     width:w.distance,
 ...
 }(), r = i(14), o = i(2), l = i(5), h = n(l), u = i(105), c = n(u), _ = i(106), d = n(_), f = i(108), v = n(f), p = i(102), m = n(p), g = i(7), y = n(g), E = i(110), w = n(E), k = i(104), b = n(k), A = i(111), T = n(A), S = i(116), C = n(S), L = i(120), R = n(L), P = i(122), O = n(P), x = i(124), I = n(x), M = i(125), D = n(M), N = i(126), H = n(N), B = i(12), j = "ready";
 t.READY_EVENT = j;
 var F = ".js-in-page-fake-shadow", V = ".js-in-page-fake-header", z = ".js-animate-out", W = -1 === navigator.userAgent.indexOf("MSIE"), U = function() {
  function e(t, i, n) {
   s(this, e), this._app = t, this.rootElem = i, this.animateElem = h["default"](z, this.rootElem)[0], 
   this._elem = n, this._fakeHeader = h["default"](V, this._elem), this._fakeShadow = h["default"](F, this._elem), 
   this._eventsAttached = !1, this._scrollBlocker = null, W && (this._scrollBlocker = new c["default"](), 
  ...
  return a(e, [ {
   ...
   value:function() {
    var e = this, t = h["default"](B.RESPONSIVE_IMAGE_SELECTOR, this._elem).map(function(t) {
     return new v["default"](e._app, t);
    }), i = h["default"](B.GRID_ITEM_SELECTOR, this._elem).map(function(t) {
     return new C["default"](e._app, t);
    }), n = h["default"](B.VIDEO_SELECTOR, this._elem).map(function(t) {
     return new O["default"](e._app, t);
    }), s = h["default"](B.ARTICLE_VIDEO, this._elem).map(function(t) {
     return new I["default"](e._app, t);
    }), a = h["default"](B.ARTICLE_YOUTUBE_VIDEO_SELECTOR, this._elem).map(function(t) {
     return new D["default"](e._app, t);
    }), r = h["default"](B.HIDDEN_CHARACTER_CONTAINER_SELECTOR, this._elem).map(function(t) {
     return new m["default"](e._app, t);
    }), o = h["default"](B.CAROUSEL_SELECTOR, this._elem).map(function(t) {
     return new w["default"](e._app, t);
    }), l = h["default"](B.ANIMATE_SCROLL_SELECTOR, this._elem).map(function(t) {
     return new b["default"](e._app, t);
    }), u = h["default"](B.SEARCH_COMPONENT_SELECTOR, this._elem).map(function(t) {
     return new T["default"](e._app, t, e);
    }), c = h["default"](B.SHARE_FAB_SELECTOR, this._elem).map(function(t) {
     return new H["default"](e._app, t);
    }), _ = h["default"](B.QUOTE_SELECTOR, this._elem).map(function(t) {
     return new R["default"](e._app, t);
    });
    return d["default"](B.AVOID_ORPHANS_SELECTOR), [].concat(t, i, n, s, a, r, o, l, u, c, _);
   }
  }, {
   key:"_onScrollStart",
   value:function() {
 ...
 o.extend(U.prototype, y["default"](j)), t["default"] = U;
}, function(e, t, i) {
 "use strict";
 function n(e) {
  return e && e.__esModule ? e :{
 ...
 var r = function() {
  ...
  return r(e, [ {
   ...
   value:function(e) {
    ...
    s && this._rect.width >= 1.75 * this._rect.height && (i = s);
    var a = i.split("."), r = a.pop();
    if ("svg" === r || "svgz" === r || "gif" === r) return i;
    var o = void 0;
   ...
   value:function() {
    this._eventsAttached || (this._eventsAttached = !0, this._app.onResize(this._onResize), 
    this._app.trackElement(this._elem, this._scrolledIntoView));
   }
  }, {
   key:"_detachEvents",
   value:function() {
 ...
 var a = function() {
 ...
 }(), r = i(2), o = i(5), l = n(o), h = i(32), u = n(h), c = i(14), _ = 30, d = ".js-carousel-items", f = ".js-carousel-slide", v = ".js-carousel-controls", p = ".js-carousel-next", m = ".js-carousel-prev", g = ".js-carousel-pager", y = ".js-carousel-pager-dots", E = "._generated-image-container", w = 600, k = function() {
  function e(t, i) {
   ...
   this._pagerDots = l["default"](y, this._pagerElem), this._scrollOffset = 0, this._slides = l["default"](f, this._elem), 
   ...
   if (n) {
    var a = l["default"](E, this._slides[0])[0];
    if (a) {
  ...
  return a(e, [ {
   ...
   value:function() {
    ...
    s && (this._firstRun ? (window.history.replaceState(null, "", window.location.href + "#" + s), 
    this._firstRun = !1) :window.location.hash = s), setTimeout(function() {
 ...
 }(), r = i(2), o = i(26), l = n(o), h = i(112), u = n(h), c = i(114), _ = n(c), d = i(115), f = n(d), v = i(5), p = n(v), m = i(103), g = 3, y = ".js-search-input", E = ".js-search-reset", w = ".js-search-results", k = new u["default"](), b = function() {
  function e(t, i, n) {
   s(this, e), this._app = t, this._elem = i, this._page = n, this._areEventsAttached = !1, 
   this._indexLoaded = !1, k.setMinimumSearchLength(g), this._input = new _["default"](this._app, p["default"](y, this._elem)[0], p["default"](E, this._elem)[0]), 
 ...
 }(), r = i(113), o = n(r), l = i(2), h = i(25), u = function() {
  function e(t) {
  ...
  return a(e, [ {
   ...
   value:function() {
    ...
    return regeneratorRuntime.async(function(t) {
     ...
     case 2:
      return this._hasIndex = !0, t.next = 5, h.getJSON("" + window.HTTP_PREFIX + "api/search-index.json");
 ...
 var a = function() {
  ...
  return a(e, [ {
   ...
   value:function(e) {
    ...
    return e.model.newWindow && (s = 'href="' + e.model.externalUrl + '" target="_blank"', 
 ...
 }(), r = i(117), o = i(2), l = i(5), h = n(l), u = i(32), c = n(u), _ = i(100), d = n(_), f = i(119), v = n(f), p = i(12), m = Math.abs, g = ".js-wave-layer", y = "wave", E = function() {
  function e(t, i) {
 ...
 var a = function() {
  ...
  function e(t, i, n) {
   ...
   this._video.style.height = "100%", this._video.preload = "none", this._video.autoPlay = !1, 
   this._video.loop = !0, this._video.controls = !1, o.set(this._video, {
    autoAlpha:0
   }), this._elem.appendChild(this._video), r.bindAll(this, "_scrolledIntoFrame", "_mouseEnter", "_mouseLeave"), 
   this._attachEvents();
  }
  return a(e, [ {
   key:"tearDown",
   ...
   key:"pause",
   value:function() {
    this._hasLoaded && this._isPlaying && (this._video.pause(), this._isPlaying = !1);
   }
  }, {
   key:"_mouseEnter",
   value:function() {
    this._hasLoaded && this.play();
   }
  }, {
   key:"_mouseLeave",
   value:function() {
    this._hasLoaded && this.pause();
   }
  }, {
   key:"_attachEvents",
   value:function() {
   ...
   value:function() {
    ...
    this._eventDelegate.off("mouseout", this._mouseLeave), this._areEventsAttached = !1);
   }
  }, {
   key:"_scrolledIntoFrame",
   value:function() {
    var e = this, t = function i() {
     4 === e._video.readyState ? (e._video.pause(), o.to(e._video, .4, {
      autoAlpha:1
     }), e._hasLoaded = !0) :setTimeout(i, 200);
    };
    this._video.src = this._videoURL, this._video.load(), this._video.play(), t();
   }
  } ]), e;
 }();
 t["default"] = u, e.exports = t["default"];
 ...
 }(), r = i(2), o = i(121), l = n(o), h = function() {
  function e(t, i) {
   var n = this;
 ...
 }(), r = i(2), o = i(14), l = i(5), h = n(l), u = i(32), c = n(u), _ = i(123), d = n(_), f = ".js-video-trigger", v = ".js-video-poster", p = ".js-video-target", m = .5, g = function() {
  function e(t, i) {
   ...
   r.bindAll(this, "_onClick"), this._attachEvents();
  }
  return a(e, [ {
   key:"tearDown",
   value:function() {
   ...
   value:function(e) {
    ...
    return regeneratorRuntime.async(function(i) {
     ...
     case 3:
      t = this, this._youTubeApi = d["default"]().then(function() {
       return t._prepareYouTubePlayer().then(function() {
        return t._playVideo(), t._fadeOutScrim();
       });
      });
 ...
 }(), r = i(2), o = i(5), l = n(o), h = ".js-article-video", u = "-is-playing", c = function() {
  function e(t, i) {
   s(this, e), this._app = t, this._elem = i, this._triggerElements = l["default"](h, this._elem), 
   this._elem.classList.contains(h.replace(/^\./, "")) && this._triggerElements.push(this._elem), 
  ...
  return a(e, [ {
   ...
   value:function(e) {
    return regeneratorRuntime.async(function(t) {
     for (;;) switch (t.prev = t.next) {
     case 0:
      e.stopPropagation(), this._elem.children[0].paused ? (this._elem.classList.add(u), 
      this._elem.children[0].play()) :(this._elem.classList.remove(u), this._elem.children[0].pause());
 ...
 }(), r = i(2), o = i(5), l = n(o), h = i(32), u = n(h), c = i(123), _ = n(c), d = ".js-article-yt-video", f = ".js-article-yt-video-target", v = "hd720", p = function() {
  function e(t, i) {
 ...
 var a = function() {
 ...
 }(), r = i(107), o = n(r), l = i(2), h = i(5), u = n(h), c = i(99), _ = n(c), d = i(12), f = i(14), v = ".js-wave-layer", p = ".js-share-fab-content", m = ".js-share-fab-toggle", g = ".js-share-fab-text", y = ".js-share-fab-parent", E = .4, w = .1, k = function() {
  function e(t, i) {
   var n = this;
   ...
   this._links = u["default"]("a", this._elem), this._parentContainer = _["default"](this._elem, y), 
  ...
  return a(e, [ {
   ...
   value:function(e) {
    if (!e.metaKey && !e.ctrlKey) {
     if (e.preventDefault(), e.stopPropagation(), this._wave && !this._FABIsActive) {
      ...
      this._wave.activate(i + s, n, "rgba(0, 0, 0, 0.4)", !1, E);
     }
     this._setFABState();
    }
   }
   ...
   key:"_setFABPosition",
   value:function() {
    this._app.currentScroll() > this._coords.top - 3 * this._elemSize && (this._isLocked || this._fixToBottom(), 
    this._app.currentScroll() > this._coords.bottom - 3 * this._elemSize ? this._isHidden || this._shrinkFAB() :this._isLocked && this._growFAB()), 
    this._app.currentScroll() < this._coords.top - 3 * this._elemSize && (this._isHidden || this._isLocked) && this._fixToTop();
   }
  }, {
   key:"_shrinkFAB",
   value:function() {
    var e = this;
    this._FABIsActive && this._closeFAB(), f.to(this._elem, E, {
     scale:0,
     ease:Expo.easeOut,
     onComplete:function() {
      e._isHidden = !0;
   ...
   value:function() {
    ...
    this._FABIsAnimating || (this._FABIsAnimating = !0, this._FABIsActive = !0, o["default"].write(function() {
     ...
     e._content.setAttribute("aria-hidden", "false"), e._enableLinks(), f.to(e._elem, E, {
   ...
   value:function() {
    ...
    this._FABIsAnimating || (this._FABIsAnimating = !0, this._FABIsActive = !1, o["default"].write(function() {
     ...
     e._content.setAttribute("aria-hidden", "true"), e._disableLinks(), f.to(e._elem, E, {
      width:e._elemSize,
      height:e._elemSize,
      ease:Expo.easeOut,
